...
@Entity(name = "calculation_shorthand_template_parameter")
public class CalculationShorthandTemplateParameter implements Serializable {
    @Id
    @Column(name = "id")
    ...
    public CalculationShorthandTemplateParameter() {}
